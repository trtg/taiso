...
<!-- end menu -->
 ...
 <div id="flare" class="shoflare">
                  <div class="pattern-about">  
                     <div class="vert-text">
                        <h1 class="">Sho Nakamori</br>Athlete & Coach</h1>
                      </div>
                  </div> 
                    ...
                    <div class="sixteen columns">
                        <div id="portfolio-filter">
                            <ul id="filter">
                                ...
                                <li><a href="#" data-filter=".videos" title="">Videos</a></li>
                                <li><a href="#" data-filter=".photos" title="">Photos</a></li>
